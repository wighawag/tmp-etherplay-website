...
<section class="py-8 px-4 text-center bg-opacity-60 bg-black" >
  <div class="max-w-auto mx-auto md:max-w-lg text-gray-100" >
    ...
    <p class="m-6 0 text-xl text-gray-200">
      We are a Game Studio Based in Scotland Building Unstoppable Games running on <a class="text-green-400 underline" href="https://ethereum.org" target="_blank">ethereum</a>.
    </p>
