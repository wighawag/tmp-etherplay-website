...
{#if active}
  <li class="-mb-px mr-1">
    <Link
      class="bg-black inline-block border-l border-t border-r rounded-t py-2 px-4 border-pink-600
...
{:else}
  <li class="-mb-px mr-1">
    <Link
      class="bg-black inline-block py-2 px-4 border-pink-600 text-pink-600 font-semibold"
      {name}
      {params}>
      <slot />
    </Link>
